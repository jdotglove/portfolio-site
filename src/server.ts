...
app.get(["/knowledge-hub", "/knowledge-hub/"], (req: Request, res: Response) => {
    console.log("Serving knowledge-hub.html");
    res.sendFile(path.resolve(__dirname, "knowledge-hub.html"));
})

app.get(["/login", "/login/"], (_req: Request, res: Response) => {
    console.log("Serving login.html");
    res.sendFile(path.resolve(__dirname, "login.html"));
});

app.get(["/create-admin", "/create-admin/"], (_req: Request, res: Response) => {
